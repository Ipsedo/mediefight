...
int main(int argc, char **argv) {
	...
	ObjMtlVBO objMtlVBO(getResFolder() + "/models/snow_baleine_obj.obj",
						...
						true);
	NormalMapModel squareMap(getResFolder() + "/models/Sponge.obj",
							 getResFolder() + "/textures/white.png",
							 getResFolder() + "/textures/Map__5_Normal_Bump.png");
	...
	while (!glfwWindowShouldClose(window)) {
		...
		glm::mat4 scale = glm::scale(glm::mat4(1.f), glm::vec3(1e-1f));
